...
@pytest.mark.parametrize('proposals, errmessage',
                         [([('A', 2, 0, 3)], r'Malformed proposal'),
                          ([('A', 3, 1)], r'If proposal "A" were funded it would receive more than the funding limit this year.'),
                          ([('A', 2, 1)], r'If proposal "A" were funded it would receive more than the funding limit this year.'),
